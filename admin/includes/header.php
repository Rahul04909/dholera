...
<header class="admin-header">
    <div class="logo-area">
        <img src="<?php echo BASE_URL; ?>assets/logo.webp" alt="Dholera Smart City Logo">
        <span class="logo-text"></span>
    </div>

    <ul class="nav-links">
        <li class="nav-item">
            <a href="<?php echo BASE_URL; ?>index.php" class="nav-link view-site" target="_blank">
        ...
        <li class="nav-item">
            <span class="nav-link">Agents <i class="fas fa-chevron-down" style="font-size: 10px;"></i></span>
            <ul class="dropdown-menu">
...
<aside class="admin-sidebar">
    <ul class="sidebar-menu">
        ...
        <li class="sidebar-item <?php echo strpos($_SERVER['PHP_SELF'], 'manage-hero.php') !== false ? 'active' : ''; ?>">
            <a href="<?php echo BASE_URL; ?>admin/frontend/manage-hero.php"><i class="fas fa-images"></i> Hero Slider</a>
        </li>
        <li class="sidebar-item <?php echo strpos($_SERVER['PHP_SELF'], 'projects') !== false ? 'active' : ''; ?>">
            <a href="<?php echo BASE_URL; ?>admin/projects/index.php"><i class="fas fa-building"></i> Manage Projects</a>
        </li>
